...
st.subheader(f'Top 5 Productos Más Vendidos en {selected_region}')
fig_sales = px.bar(top_5_products, x='Sales', y='Product Name', title=f'Top 5 Productos Más Vendidos en {selected_region}')
...
st.subheader(f'Top 5 Productos por Ganancia en {selected_region}')
fig_profit = px.bar(top_5_profit_products, x='Profit', y='Product Name', title=f'Top 5 Productos por Ganancia en {selected_region}')
...
st.subheader(f'Detalles de los 5 Productos Más Vendidos en {selected_region}')
top_5_products_details = filtered_df[filtered_df['Product Name'].isin(top_5_products['Product Name'])]
st.write(top_5_products_details[['Product Name', 'Sales', 'Profit', 'Quantity', 'Region']]) # Added Region column
